...
function start_server(ws) {
    ...
    gameserver.post("/pending-games", (req, res) => __awaiter(this, void 0, void 0, function* () {
        const { creator, number_of_players } = req.body;
        const game = api.new_game(creator, number_of_players);
        res.send(game);
        api.broadcast(game);
    }));
    gameserver.get("/games", (_, res) => __awaiter(this, void 0, void 0, function* () {
        const games = api.games();
        res.send(games);
    }));
    gameserver.post("/games/:id/actions", (req, res) => __awaiter(this, void 0, void 0, function* () {
