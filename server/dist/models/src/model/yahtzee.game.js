...
function register(slot, yahtzee) {
    if ((0, yahtzee_score_1.isLowerSection)(slot)) {
        ...
        return {
            ...yahtzee,
            lower_sections: (0, array_utils_1.update)(playerInTurn, (0, yahtzee_score_1.register_lower)(section, slot, roll), lower_sections),
        ...
        return {
            ...yahtzee,
            upper_sections: (0, array_utils_1.update)(playerInTurn, (0, yahtzee_score_1.register_upper)(section, slot, roll), upper_sections),
            playerInTurn: (playerInTurn + 1) % yahtzee.players.length,
            roll: yahtzee.roller.roll(5),
            rolls_left: 2
        };
