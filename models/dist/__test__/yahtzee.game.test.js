...
import { is_finished, new_yahtzee, register, reroll, scores } from '../src/model/yahtzee.game';
...
describe("new game", () => {
    const yahtzee = new_yahtzee({
        players: ['A', 'B', 'C', 'D'],
        randomizer: non_random(3, 1, 0, // Reversing in Fisher-Yates
...
describe("reroll", () => {
    ...
    it("disallows re-rolling if no rolls are left", () => {
        expect(() => reroll([1, 2, 3], Object.assign(Object.assign({}, yahtzee), { rolls_left: 0 }))).toThrow();
    });
});
describe("reroll", () => {
    const yahtzee = new_yahtzee({
...
describe("register", () => {
    describe("registering in the upper section", () => {
        ...
        it("moves to the first player after the last player", () => {
            const registered = register(2, Object.assign(Object.assign({}, rerolled_twice), { playerInTurn: 3 }));
        ...
        it("disallows registering an already registered slot", () => {
            ...
            const used = Object.assign(Object.assign({}, rerolled_twice), { upper_sections: update(0, { scores: Object.assign(Object.assign({}, section.scores), { [2]: 8 }) }, rerolled_twice.upper_sections) });
    ...
    describe("registering in lower the section", () => {
        ...
        it("moves to the first player after the last player", () => {
            const registered = register('large straight', Object.assign(Object.assign({}, rerolled_twice), { playerInTurn: 3 }));
            expect(registered.playerInTurn).toEqual(0);
        });
        it("rolls new dice", () => {
            expect(registered.roll).toEqual([6, 5, 4, 3, 2]);
        ...
        it("disallows registering an already registered slot", () => {
            ...
            const used = Object.assign(Object.assign({}, rerolled_twice), { lower_sections: update(0, { scores: Object.assign(Object.assign({}, section.scores), { ['large straight']: 20 }) }, rerolled_twice.lower_sections) });
...
const { roller } = finished, cloneable = __rest(finished, ["roller"]);
const almost_finished = Object.assign(Object.assign({}, structuredClone(cloneable)), { roller });
